    ...
    >
      ...
      >
        <SliderPrimitive.Track
          ...
          className="bg-muted relative overflow-hidden rounded-md select-none data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5"
        >
